...
function showForm() {
  ...
  container.innerHTML = `
    ...
    <iframe src="https://docs.google.com/forms/d/e/${formId}/viewform?embedded=true${url}" width="100%" height="4500" frameborder="0" marginheight="0" marginwidth="0">Carregando...</iframe>

...
function showForm() {
  ...
  container.innerHTML = `
    ...
    <iframe src="https://docs.google.com/forms/d/e/${formId}/viewform?embedded=true" width="800" height="1000" frameborder="0" marginheight="0" marginwidth="0">Carregando...</iframe>
